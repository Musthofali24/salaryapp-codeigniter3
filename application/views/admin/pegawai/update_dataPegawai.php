                ...
                <div class="form-group">
                    ...
                    <select name="id_jabatan" class="form-control">
                        <?php foreach ($jabatan as $j) : ?>
                            <option value="<?php echo $j->id_jabatan ?>" <?php echo ($p->id_jabatan === $j->id_jabatan) ? 'selected' : '' ?>>
                ...
                <div class="form-group">
                    ...
                    <select name="id_akses" class="form-control">
                        <?php foreach ($hak_akses as $h) : ?>
                            <option value="<?php echo $h->id_akses ?>" <?php echo ($p->id_akses === $h->id_akses) ? 'selected' : '' ?>>
